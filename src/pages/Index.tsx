...
const MENU = [
  {
    category: "Классика",
    items: [
      { name: "Пепперони", desc: "Соус томатный, сыр моцарелла, пепперони, сыр пармезан", sizes: { s: "469 ₽", m: "809 ₽", l: "999 ₽" }, tag: "Хит", img: MENU_IMG },
      { name: "Маргарита", desc: "Соус томатный, сыр моцарелла, сыр пармезан, томаты черри, итальянские травы", sizes: { s: "649 ₽", m: "799 ₽", l: "899 ₽" }, tag: "", img: MENU_IMG },
      { name: "Куриная Барбекю", desc: "Соус томатный, сыр моцарелла", sizes: { s: "479 ₽", m: "639 ₽", l: "819 ₽" }, tag: "", img: MENU_IMG },
      { name: "Ветчина и Грибы", desc: "Соус томатный, сыр моцарелла, грибы, ветчина", sizes: { s: "479 ₽", m: "659 ₽", l: "949 ₽" }, tag: "", img: MENU_IMG },
      { name: "Четыре сезона", desc: "Соус Альфредо, сыр моцарелла, куриное филе, томаты черри, салат айсберг, соус Цезарь, сыр пармезан", sizes: { s: "889 ₽", m: "989 ₽", l: "" }, tag: "", img: MENU_IMG },
    ],
  },
  {
    category: "Фирменные",
    items: [
      { name: "Карбонара", desc: "Соус альфредо, сыр моцарелла, бекон, пармезан, яичный желток, лук красный, петрушка", sizes: { s: "679 ₽", m: "979 ₽", l: "1159 ₽" }, tag: "NEW", img: MENU_IMG },
      { name: "Адана Пицца", desc: "Соус томатный, сыр моцарелла, лук красный, колбаски острая, пепперони, грибы, томаты черри, соус Шираза, жареный лук, соус Адана", sizes: { s: "839 ₽", m: "949 ₽", l: "1149 ₽" }, tag: "Фирменная", img: MENU_IMG },
      { name: "Пять Сыров", desc: "Ветчина, охотничьи колбаски, бекон, говядина, сыр моцарелла, сыр чеддер, пармезан, соус Бешамель, перец молотый", sizes: { s: "679 ₽", m: "979 ₽", l: "1049 ₽" }, tag: "", img: MENU_IMG },
      { name: "Премьер", desc: "Соус томатный, сыр моцарелла, пепперони, ветчина, бекон, сыр пармезан, жареный лук", sizes: { s: "649 ₽", m: "839 ₽", l: "1009 ₽" }, tag: "", img: MENU_IMG },
      { name: "Гавайская Делюкс", desc: "Фирменный томатный соус, Альфредо, сыр моцарелла, ветчина, куриное филе, ананас", sizes: { s: "629 ₽", m: "809 ₽", l: "919 ₽" }, tag: "", img: MENU_IMG },
    ],
  },
  {
    category: "Мясные",
    items: [
      { name: "Четыре мяса", desc: "Ветчина, охотничьи колбаски, бекон, говядина, сыр моцарелла, фирменный томатный соус, перец молотый", sizes: { s: "729 ₽", m: "889 ₽", l: "1019 ₽" }, tag: "", img: MENU_IMG },
      { name: "Мясной микс", desc: "Соус томатный, сыр моцарелла, пепперони, бекон, свинина, колбаски, ветчина", sizes: { s: "799 ₽", m: "939 ₽", l: "1169 ₽" }, tag: "", img: MENU_IMG },
      { name: "Мясная Барбекю", desc: "Соус томатный, сыр моцарелла, колбаски охотничьи, свинина, бекон, говядина, сыр чеддер, соус барбекю", sizes: { s: "719 ₽", m: "919 ₽", l: "1019 ₽" }, tag: "", img: MENU_IMG },
      { name: "Донация", desc: "Соус сливочный, сыр моцарелла, бекон, ветчина, томаты черри, перец сладкий, тесто", sizes: { s: "629 ₽", m: "809 ₽", l: "919 ₽" }, tag: "", img: MENU_IMG },
      { name: "Дабл Пепперони Халапь", desc: "Соус томатный, сыр моцарелла, пепперони, сыр чеддер, томатные чипсы", sizes: { s: "469 ₽", m: "849 ₽", l: "1019 ₽" }, tag: "", img: MENU_IMG },
    ],
  },
  {
    category: "Особые",
    items: [
      { name: "Жюльен", desc: "Соус грибной, сыр моцарелла, грибы, лук красный, куриное филе, сыр пармезан, жареный лук", sizes: { s: "739 ₽", m: "909 ₽", l: "1019 ₽" }, tag: "", img: MENU_IMG },
      { name: "Мексиканская острая", desc: "Соус медовая, пепперони, говядина, перец сладкий, перец Халапеньо, сыр чеддер, фирменный острый соус", sizes: { s: "739 ₽", m: "859 ₽", l: "1109 ₽" }, tag: "", img: MENU_IMG },
      { name: "Курочка Барбекю", desc: "Соус томатный, соус барбекю, сыр моцарелла, говядина, лук красный, грибы, перед халапеньо", sizes: { s: "629 ₽", m: "819 ₽", l: "979 ₽" }, tag: "", img: MENU_IMG },
      { name: "Баварская", desc: "Соус томатный, сыр моцарелла, колбаски охотничьи, лук красный, огурцы маринованные, томаты черри, соус медово-горчичный", sizes: { s: "739 ₽", m: "889 ₽", l: "1159 ₽" }, tag: "", img: MENU_IMG },
      { name: "Цезарь", desc: "Соус Альфредо, сыр моцарелла, куриное филе, томаты черри, салат айсберг, соус Цезарь, сыр пармезан", sizes: { s: "609 ₽", m: "869 ₽", l: "1089 ₽" }, tag: "", img: MENU_IMG },
    ],
  },
  {
    category: "Другие",
    items: [
      { name: "Лесные грибы", desc: "Соус Альфредо, сыр моцарелла, шампиньоны, лисички, опята, лук красный, сыр пармезан", sizes: { s: "629 ₽", m: "849 ₽", l: "995 ₽" }, tag: "", img: MENU_IMG },
      { name: "Ветчина и сыр", desc: "Соус Альфредо, сыр моцарелла, ветчина, сыр пармезан, сыр чеддер", sizes: { s: "599 ₽", m: "729 ₽", l: "889 ₽" }, tag: "", img: MENU_IMG },
      { name: "Морская", desc: "Соус Альфредо, сыр моцарелла, креветки, лосось, мидии, кальмары, томаты свежие, каперсы, салат рукола", sizes: { s: "759 ₽", m: "999 ₽", l: "1249 ₽" }, tag: "", img: MENU_IMG },
      { name: "Сырная", desc: "Соус Альфредо, сыр моцарелла, пармезан, чеддер, итальянские травы", sizes: { s: "839 ₽", m: "849 ₽", l: "1169 ₽" }, tag: "", img: MENU_IMG },
      { name: "Вегетарианская", desc: "Соус томатный, сыр моцарелла, перец сладкий, томаты свежие, маслины, фета, итальянские травы", sizes: { s: "629 ₽", m: "839 ₽", l: "949 ₽" }, tag: "", img: MENU_IMG },
      { name: "Дабл Пепперони", desc: "Соус томатный, сыр моцарелла, пепперони, пармезан", sizes: { s: "469 ₽", m: "899 ₽", l: "1109 ₽" }, tag: "", img: MENU_IMG },
      { name: "Пепперони Халапь", desc: "Соус томатный, сыр моцарелла, пепперони", sizes: { s: "449 ₽", m: "799 ₽", l: "990 ₽" }, tag: "", img: MENU_IMG },
    ],
  },
];
