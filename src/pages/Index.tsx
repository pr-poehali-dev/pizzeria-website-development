          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-body text-foreground/70 text-base leading-relaxed mb-8">
                Тонкое тесто, дровяная печь и только качественные продукты — наш принцип с первого дня. Мы рады каждому гостю и стараемся, чтобы каждый кусочек был вкусным.
              </p>
